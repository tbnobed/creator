...
export const imageModels: ImageModel[] = [
  {
    ...
    provider: "LOCAL",
    description: "Fast Apache-2.0 text-to-image model for an installed ComfyUI worker.",
    operations: ["generate"],
  ...
  },
  {
    ...
    provider: "LOCAL",
    description: "High-detail text and photoreal image generation on a compatible ComfyUI worker.",
    operations: ["generate"],
    aspectRatios: standardRatios,
    maxImages: 4,
    supportsSeed: true,
  ...
  },
  {
    ...
    name: "Z-Image Turbo",
    provider: "LOCAL",
    description: "Efficient Apache-2.0 text-to-image generation with an 8-step ComfyUI workflow.",
    operations: ["generate"],
    aspectRatios: standardRatios,
    maxImages: 4,
    supportsSeed: true,
