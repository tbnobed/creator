...
**How to apply:** Put the complete shot list in the Full Script field and reserve Visual Storyline for global continuity instructions. Distribute the project target duration across the explicit blocks rather than replacing or duplicating them.